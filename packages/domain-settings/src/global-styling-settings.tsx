            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-3">
                <input
                  type="color"
                  value={
                    /^#[0-9A-Fa-f]{6}$/i.test(tokens.primaryColor || "")
                      ? tokens.primaryColor
                      : "#00f0ff"
                  }
                  onChange={(e) =>
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-3">
                <input
                  type="color"
                  value={
                    /^#[0-9A-Fa-f]{6}$/i.test(tokens.accentColor || "")
                      ? tokens.accentColor
                      : "#00f0ff"
                  }
                  onChange={(e) =>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      type="color"
                      value={
                        /^#[0-9A-Fa-f]{6}$/i.test(tokens.headingColor || "")
                          ? tokens.headingColor
                          : "#ffffff"
                      }
                      onChange={(e) =>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      type="color"
                      value={
                        /^#[0-9A-Fa-f]{6}$/i.test(tokens.subtitleColor || "")
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      type="color"
                      value={
                        /^#[0-9A-Fa-f]{6}$/i.test(tokens.bodyColor || "")
                          ? tokens.bodyColor
                          : "#ffffff"
                      }
                      onChange={(e) =>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <textarea
              ...
              onChange={(e) =>
                setTokens((prev) => ({ ...prev, globalCss: e.target.value }))
              }
