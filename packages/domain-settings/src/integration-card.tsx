  ...
  return (
    <div
      className={`p-6 rounded-2xl border transition-all duration-300 backdrop-blur-md relative overflow-hidden flex flex-col justify-between min-h-[280px] ${
        status.connected
          ? "bg-emerald-950/10 border-emerald-500/30 shadow-[0_0_15px_-3px_rgba(16,185,129,0.1)]"
          : "bg-zinc-950/40 border-zinc-800 hover:border-zinc-700 shadow-xl"
      }`}
    >
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-start">
          ...
          {status.connected ? (
            ...
            <span className="flex items-center gap-1.5 text-xs text-zinc-500 dark:text-zinc-400 bg-card/50 px-2.5 py-1 rounded-full border border-zinc-800">
        ...
        {status.connected && (
          <div className="bg-card/40 border border-zinc-850 rounded-xl p-3 text-xs">
