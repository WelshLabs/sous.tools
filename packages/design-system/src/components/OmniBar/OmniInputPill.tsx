...
export function OmniInputPill({
  ...
  return (
    ...
    >
      ...
      <div
        className={`w-full flex flex-col px-2 z-10 ${isDragging ? "opacity-0" : "opacity-100"}`}
      >
        {/* ── Main row ── */}
        <div className="flex items-center gap-2">
          ...
          >
            <Lettermark
              gradient
              className={`w-7 h-7 transition-opacity ${isProcessing ? "animate-pulse opacity-60" : "opacity-100"}`}
            />
          </span>
