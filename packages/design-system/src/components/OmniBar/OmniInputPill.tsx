...
export function OmniInputPill({
  ...
  return (
    <motion.div
      ...
      onDrop={handleDrop}
      className="border-border pointer-events-auto relative mx-auto flex max-w-[92vw] flex-col justify-center overflow-visible border p-2 backdrop-blur-xl sm:max-w-full"
      style={{
