  ...
  switch (block.type) {
                ...
                <div className="absolute top-0 left-0 px-2 py-1 bg-secondary border-b border-r border-border rounded-br-lg rounded-tl-lg text-[9px] font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-1 z-30 pointer-events-none">
                  {dragProps && (
                    <div
                      ...
                      className="cursor-grab active:cursor-grabbing pointer-events-auto flex items-center justify-center p-0.5 hover:bg-background/10 dark:bg-background/10 rounded"
                    >
    ...
    case "ExplodedItemBlock": {
      ...
      return renderDraggable((dragProps) => (
        ...
        >
          <div
            className="absolute top-0 left-0 px-2 py-1 bg-secondary border-b border-r border-border rounded-br-lg rounded-tl-lg text-[9px] font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-1 z-30 pointer-events-auto cursor-pointer hover:bg-zinc-700 transition-colors"
            onClick={(e) => {
              e.stopPropagation();
          ...
          >
            {dragProps && (
              <div
                {...dragProps.dragHandleProps}
                className="cursor-grab active:cursor-grabbing flex items-center justify-center p-0.5 hover:bg-background/10 dark:bg-background/10 rounded"
              ...
              <>
                {(!(block as { hideTitle?: boolean }).hideTitle ||
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    {!(block as { hidePrice?: boolean }).hidePrice && (
                      <span className="font-mono text-cyan-400 font-bold ml-auto">
            ...
            >
              {(dropProps) => (
                <div
                  ref={dropProps.innerRef}
                  {...dropProps.droppableProps}
                  className="flex flex-col gap-3 flex-1 w-full h-full p-3 bg-background/20 min-h-[100px] min-w-[100px]"
                  onClick={handleSelect}
                >
                  <BlockChildren
                    childrenBlocks={block.blocks}
