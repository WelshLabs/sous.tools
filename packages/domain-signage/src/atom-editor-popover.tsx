          ...
          <div className="space-y-2.5">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <input
                ...
                value={style.shadow ?? ""}
                onChange={(e) =>
                  onChange({ shadow: e.target.value || undefined })
                }
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <select
                ...
                onChange={(e) =>
                  onChange({
                    animation: e.target.value as typeof style.animation,
                  })
                }
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <input
                ...
                onChange={(e) =>
                  onChange({ dimOpacity: Number(e.target.value) })
                }
                className="w-16 bg-zinc-800 border border-black/10 dark:border-white/10 rounded-lg px-2 py-1 text-xs text-zinc-900 dark:text-zinc-100 focus:outline-none"
              />
            </div>
            <div className="flex gap-4 flex-wrap">
              ...
              <label className="flex items-center gap-1.5 text-xs text-zinc-500 dark:text-zinc-400 cursor-pointer">
                <input
                  ...
                  onChange={(e) =>
                    onChange({ strikethrough: e.target.checked })
                  }
                  className="accent-primary"
                />
                Strikethrough
