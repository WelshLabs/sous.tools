  ...
  return (
    <div className="absolute inset-0 bg-background/95 border border-border p-2.5 z-20 flex flex-col">
      <div className="flex items-center justify-between border-b border-zinc-900 pb-1.5 mb-2">
        <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Configure Widget</span>
        <button onClick={onClose} className="text-muted-foreground hover:text-muted-foreground cursor-pointer">
      ...
      <div className="flex-1 overflow-y-auto space-y-2 pr-1">
        {column.type === "MENU" && (
          <div className="space-y-1">
            <label className="text-[9px] text-muted-foreground font-semibold uppercase">Menu Items</label>
            <MenuItemSelector
              items={items}
        ...
        {column.type === "IMAGE" && (
          <div className="space-y-2">
            <div className="space-y-0.5">
              <label className="text-[9px] text-muted-foreground font-semibold uppercase">Image URL</label>
              <input
                type="text"
            ...
            <div className="space-y-0.5">
              <label className="text-[9px] text-muted-foreground font-semibold uppercase">Fit Mode</label>
              <select
        ...
        {column.type === "TEXT" && (
          <div className="space-y-2">
            <div className="space-y-0.5">
              <label className="text-[9px] text-muted-foreground font-semibold uppercase">Header Title</label>
              <input
                type="text"
                value={column.title || ""}
            ...
            <div className="space-y-0.5">
              <label className="text-[9px] text-muted-foreground font-semibold uppercase">Content Text</label>
              <textarea
