...
export const LayoutPreview: React.FC<LayoutPreviewProps> = ({
  ...
  const previewContent = (
    <div
      className={`st-layout-background relative flex min-h-[100vh] w-full flex-1 flex-col ${config.aspectRatio === "responsive" ? "" : "border-border rounded-2xl border-2 shadow-2xl"}`}
      style={bgStyle}
    >
      {!activeSlide ? (
  ...
  return (
    <div
      className="signage-preview-container bg-background dark:bg-background st-signage-root relative flex min-h-full w-full items-start justify-center pt-8 pb-32"
      ref={containerRef}
    >
