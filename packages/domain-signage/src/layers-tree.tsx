      ...
      >
        {isContainer ? (
          <button
            ...
            className="p-0.5 hover:bg-background/10 dark:bg-background/10 rounded"
          >
            {expanded ? (
  ...
  return (
    <div className="flex flex-col flex-1 overflow-y-auto p-2">
      <div className="flex flex-col gap-1">
        <div className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground px-2 py-1 mb-1">
          Root Layout
        </div>
