...
import { DisplayManager } from "./DisplayManager.container";
import { type SignageDisplay } from "@soustools/api-types";
import { api } from "@soustools/api-client";

export interface DevicesManagerProps {
  displays: SignageDisplay[];
  layouts: any[];
  edgeDevices?: any[];
}

export function DevicesManagerContainer({
  displays,
  layouts,
  edgeDevices,
}: DevicesManagerProps) {
...
export { DevicesManagerContainer as DevicesManager };
