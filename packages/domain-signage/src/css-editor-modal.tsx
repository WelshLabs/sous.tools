        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          >
            <div className="flex items-center justify-between px-2 py-2.5 border-b border-black/5 dark:border-white/5 shrink-0">
              {!isCollapsed && (
                <span className="text-[11px] font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest ml-1">
                  Reference
                </span>
              )}
              <button
              ...
              <div className="flex-1 overflow-y-auto p-3 space-y-4">
                ...
                <div className="bg-zinc-950/50 border border-black/5 dark:border-white/5 rounded-xl p-3">
                  ...
                  <div className="space-y-2">
                    {Object.entries(CSS_DICTIONARY).map(
                      ([category, classes]) => (
                        <details
                          key={category}
                        ...
                        >
                          ...
                          <div className="px-2 pb-2 space-y-1.5 pt-1 border-t border-black/5 dark:border-white/5 bg-zinc-950/30">
                            {classes.map((d) => (
                              <div
                                key={d.className}
                                className="flex justify-between items-start gap-1 p-1.5 rounded hover:bg-zinc-800 text-[11px]"
                              >
                                <div className="min-w-0">
                                  <span className="font-mono text-blue-400 font-semibold truncate block">
                                    {d.className}
                                  </span>
                                  <span className="text-zinc-400 dark:text-zinc-500 text-[10px] block">
                                    {d.desc}
                                  </span>
                                </div>
                  ...
                  <div className="space-y-2">
                    {CSS_PRESETS.map((p) => (
                      ...
                      >
                        ...
                        <div className="text-[9px] text-zinc-400 dark:text-zinc-500 truncate font-mono mt-0.5">
                          {p.css.split("\n")[0]}...
                        </div>
                      </button>
                    ))}
