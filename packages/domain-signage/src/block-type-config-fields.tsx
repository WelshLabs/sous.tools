...
export function BlockTypeConfigFields({
  ...
  return (
    <div className="flex-1 overflow-y-auto px-4 py-4 min-h-0 space-y-6">
      ...
      <MenuListBlockConfig selectedBlock={selectedBlock} selectedBlockId={selectedBlockId} onUpdateBlock={onUpdateBlock} items={items} />
      <CategoryHeaderBlockConfig selectedBlock={selectedBlock} selectedBlockId={selectedBlockId} onUpdateBlock={onUpdateBlock} />
      <ModifierGroupBlockConfig selectedBlock={selectedBlock} selectedBlockId={selectedBlockId} onUpdateBlock={onUpdateBlock} onFetchModifierGroups={onFetchModifierGroups} parentExplodedItem={parentExplodedItem} />
      <ImageBlockConfig selectedBlock={selectedBlock} selectedBlockId={selectedBlockId} onUpdateBlock={onUpdateBlock} />
      <VideoBlockConfig selectedBlock={selectedBlock} selectedBlockId={selectedBlockId} onUpdateBlock={onUpdateBlock} />
      <TimelineBlockConfig selectedBlock={selectedBlock} selectedBlockId={selectedBlockId} onUpdateBlock={onUpdateBlock} />
      <NestedItemBlockConfig selectedBlock={selectedBlock} selectedBlockId={selectedBlockId} onUpdateBlock={onUpdateBlock} items={items} />
      <MediaCarouselBlockConfig selectedBlock={selectedBlock} selectedBlockId={selectedBlockId} onUpdateBlock={onUpdateBlock} />
