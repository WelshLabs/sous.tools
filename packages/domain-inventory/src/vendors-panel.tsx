...
import { VendorCardForm } from "./vendor-card-form";
...
/** Container: Vendor management panel with inline edit/create via VendorCardForm. */
              ...
              <div>
                ...
                <div className="space-y-2 mt-4 text-sm text-zinc-600 dark:text-zinc-400">
                  <div className="flex justify-between">
                    ...
                    <span className="capitalize">{vendor.order_method?.toLowerCase() ?? "None set"}</span>
                  </div>
                  {vendor.email && (
                    <div className="flex justify-between">
