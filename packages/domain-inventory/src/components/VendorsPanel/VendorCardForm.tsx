          ...
          {DAYS_OF_WEEK.map((day) => {
            ...
            return (
              <button
                ...
                className={`px-2 py-1 text-xs rounded transition-colors border cursor-pointer ${isSelected ? "bg-sky-500 border-sky-500 text-foreground" : "bg-white dark:bg-card border-zinc-200 dark:border-border text-zinc-600 dark:text-zinc-400 hover:border-sky-500"}`}
              >
                {day.slice(0, 3)}
              </button>
            );
