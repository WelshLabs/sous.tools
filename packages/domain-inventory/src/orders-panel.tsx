...
import { OrdersHistoryTab } from "./orders-history-tab";
import { OrdersListTab } from "./orders-list-tab";
...
/** Container: Order Manager panel orchestrating the living list and order history tabs. */
