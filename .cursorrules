...
- **Semantic Variables Only:** Hardcoding legacy Tailwind colors (e.g., slate-_), arbitrary values (e.g., w-[32px], bg-[#123456]), or absolute z-indexes is forbidden. Strictly use semantic CSS variables (e.g., var(--z-overlay)) and the "Midnight Slate" (zinc-_) palette defined in @soustools/design-system.
