...
const content: Record<LoginState, { label: string; icon: React.ReactNode }> = {
  ...
  loading: { label: "Signing in…", icon: <Spinner size="sm" className="[&>span]:h-5 [&>span]:w-5" /> },
  success: { label: "Welcome back", icon: <Check className="h-4 w-4" strokeWidth={3} /> },
  error: { label: "Try again", icon: <X className="h-4 w-4" strokeWidth={3} /> },
}
