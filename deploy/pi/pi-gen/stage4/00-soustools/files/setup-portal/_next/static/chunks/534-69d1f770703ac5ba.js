  ...
  [534],
  {
    ...
    6550: function (e, t, n) {
      ...
      let y = a.default.forwardRef(function (e, t) {
        ...
        let w = a.default.useContext(f.RouterContext),
          j = a.default.useContext(d.AppRouterContext),
          M = null != w ? w : j,
          L = !w,
          k = !1 !== P,
          D = null === P ? g.PrefetchKind.AUTO : g.PrefetchKind.FULL,
          { href: U, as: F } = a.default.useMemo(() => {
            if (!w) {
              let e = R(l);
              return { href: e, as: m ? R(m) : e };
            }
            let [e, t] = (0, i.resolveHref)(w, l, !0);
            return { href: e, as: m ? (0, i.resolveHref)(w, m) : t || e };
          }, [w, l, m]),
        ...
        let G = C ? r && "object" == typeof r && r.ref : t,
          ...
          V = a.default.useCallback(
            (e) => {
              ((W.current !== F || X.current !== U) &&
                (B(), (W.current = F), (X.current = U)),
                H(e),
                G &&
                  ("function" == typeof G
                    ? G(e)
        ...
        a.default.useEffect(() => {
          M && Y && k && E(M, U, F, { locale: O }, { kind: D }, L);
        }, [F, U, Y, O, k, null == w ? void 0 : w.locale, M, L, D]);
        let K = {
          ref: V,
          onClick(e) {
        ...
        if ((0, s.isAbsoluteUrl)(F)) K.href = F;
          ...
          K.href =
            t ||
            (0, _.addBasePath)(
              (0, c.addLocale)(F, e, null == w ? void 0 : w.defaultLocale),
            );
        }
        return C
          ? a.default.cloneElement(r, K)
          : (0, o.jsx)("a", { ...x, ...K, children: n });
      });
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
    ...
    3261: function (e, t, n) {
      ...
      let r = n(9793)._(n(4987)).default.createContext(null);
    },
    1245: function (e, t, n) {
      (Object.defineProperty(t, "__esModule", { value: !0 }),
        (function (e, t) {
      ...
      let s = (e) => {
        ...
        d = (0, r.forwardRef)((e, t) => {
          ...
          let {
            ...
            b = (null != p ? p : y)
              ? (24 * Number(null != d ? d : R)) / Number(null != c ? c : E)
              : null != d
                ? d
                : R;
          return (0, r.createElement)(
            "svg",
            {
              ...
              ...l,
              width:
                null !== (a = null != c ? c : E) && void 0 !== a ? a : l.width,
              height:
                null !== (i = null != c ? c : E) && void 0 !== i ? i : l.height,
              stroke: null != u ? u : P,
              strokeWidth: b,
              className: o("lucide", S, h),
              ...(!_ && !s(m) && { "aria-hidden": "true" }),
              ...m,
            },
            [
              ...g.map((e) => {
        ...
        p = (e, t) => {
          let n = (0, r.forwardRef)((n, i) => {
            ...
            return (0, r.createElement)(d, {
              ref: i,
              iconNode: t,
              className: o("lucide-".concat(a(u(e))), "lucide-".concat(e), l),
              ...s,
            });
          });
    ...
    8098: function (e, t, n) {
      ...
      let r = (0, n(8605).Z)("layout-dashboard", [
        [
          "rect",
