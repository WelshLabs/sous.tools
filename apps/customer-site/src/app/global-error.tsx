...
/**
 * GlobalError catches errors at the very root level (including layout.tsx) for customer-site.
 * Renders fallback HTML and body tags.
 */
export default function GlobalError({ error, reset }: GlobalErrorProps) {
  useEffect(() => {
    logger.error({ err: error, digest: error.digest }, "Root customer-site global layout error caught");
  }, [error]);
