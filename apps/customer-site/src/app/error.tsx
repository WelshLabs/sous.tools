...
/**
 * ErrorBoundary is caught at the customer site layout level.
 * It logs errors to the browser logger and displays a customer-friendly error message.
 */
export default function ErrorBoundary({ error, reset }: ErrorBoundaryProps) {
  useEffect(() => {
    logger.error({ err: error, digest: error.digest }, "Global customer-site layout error caught by boundary");
  }, [error]);
