...
export const SCHEMA_REGISTRY: Record<string, RegistryConfig> = {
  ...
  signage_displays: {
    ...
    relationships: [
      ...
      {
        fkField: "layout_id",
        relationLabel: "HAS_LAYOUT",
        targetLabel: "SignageLayout",
      },
    ],
  },
  vessel_profiles: {
  ...
  recipes: {
    ...
    relationships: [
      ...
      {
        fkField: "vessel_id",
        relationLabel: "USES_VESSEL",
        targetLabel: "VesselProfile",
      },
    ],
  },
  recipe_ingredients: {
    ...
    relationships: [
      {
        fkField: "recipe_id",
        relationLabel: "INGREDIENT_OF",
        targetLabel: "Recipe",
      },
      {
        fkField: "master_item_id",
        relationLabel: "OF_INGREDIENT",
        targetLabel: "MasterItem",
      },
      {
        fkField: "sub_recipe_id",
        relationLabel: "OF_SUB_RECIPE",
        targetLabel: "Recipe",
      },
  ...
  pos_items: {
    ...
    relationships: [
      ...
      {
        fkField: "category_id",
        relationLabel: "IN_CATEGORY",
        targetLabel: "PosCategory",
      },
    ],
  },
  pos_categories: {
  ...
  pos_modifier_options: {
    ...
    relationships: [
      {
        fkField: "modifier_group_id",
        relationLabel: "PART_OF_GROUP",
        targetLabel: "PosModifierGroup",
      },
    ],
  },
  ...
  vendor_item_aliases: {
    ...
    relationships: [
      ...
      {
        fkField: "vendor_id",
        relationLabel: "BELONGS_TO_VENDOR",
        targetLabel: "Vendor",
      },
      {
        fkField: "internal_item_id",
        relationLabel: "ALIAS_OF",
        targetLabel: "Item",
      },
    ],
  },
  ...
  pos_order_line_items: {
    ...
    customProperties: (record) => ({
      ...
      basePriceMoney: record.base_price_money
        ? parseFloat(record.base_price_money)
        : 0,
      grossSalesMoney: record.gross_sales_money
        ? parseFloat(record.gross_sales_money)
        : 0,
    }),
  },
  tickets: {
  ...
  wastage_logs: {
    ...
    relationships: [
      ...
      {
        fkField: "recipe_id",
        relationLabel: "WASTED_RECIPE",
        targetLabel: "Recipe",
      },
      {
        fkField: "recorded_by",
        relationLabel: "REPORTED_BY",
        targetLabel: "User",
      },
    ],
  },
  ...
  ingredient_substitutions: {
    ...
    relationships: [
      {
        fkField: "parent_ingredient_id",
        relationLabel: "SUBSTITUTES_FOR",
        targetLabel: "MasterItem",
      },
      {
        fkField: "substitute_ingredient_id",
        relationLabel: "SUBSTITUTE_WITH",
        targetLabel: "MasterItem",
      },
      {
        fkField: "organization_id",
