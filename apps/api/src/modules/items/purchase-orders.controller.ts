...
export class PurchaseOrdersController {
  ...
  @Post('draft-item')
  async addItemToDraft(@Body() body: AddItemToDraftDto): Promise<ApiResponse<Record<string, unknown>>> {
    try {
  ...
  @Patch('items/:id')
  async updateItem(@Param('id') id: string, @Body() body: UpdatePoItemDto): Promise<ApiResponse<Record<string, unknown>>> {
    try {
  ...
  @Delete('items/:id')
  async removeItem(@Param('id') id: string): Promise<ApiResponse<Record<string, unknown>>> {
    try {
  ...
  @Patch(':id/submit')
  async submitPo(@Param('id') id: string): Promise<ApiResponse<Record<string, unknown>>> {
    try {
