...
export default function GlobalError({ error, reset }: GlobalErrorProps) {
  useEffect(() => {
    console.error("Setup Portal global layout error caught", { err: error, digest: error.digest });
  }, [error]);
    ...
    <html lang="en">
      <body className="antialiased min-h-screen bg-card text-zinc-50 font-sans flex items-center justify-center p-4">
        <div className="glass-panel p-8 rounded-lg max-w-md border border-zinc-900 text-center">
          <h2 className="text-xl font-semibold text-rose-500 mb-4">Critical Setup Portal Error</h2>
