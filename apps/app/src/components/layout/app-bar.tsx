      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="relative p-2 rounded-full hover:bg-zinc-100 dark:hover:bg-black/5 dark:bg-white/5 transition-colors focus:outline-none cursor-pointer text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white"
                  ...
                  {notifications.length === 0 ? (
                    ...
                    notifications.map((n) => (
                      <div
                        ...
                        className="p-3 border-b border-zinc-200 dark:border-white/5 hover:bg-zinc-50 dark:hover:bg-black/5 dark:bg-white/5 transition-colors cursor-pointer text-left last:border-b-0"
                      >
        ...
        <button
          ...
          className="flex items-center gap-2 p-1.5 rounded-full hover:bg-zinc-100 dark:hover:bg-black/5 dark:bg-white/5 transition-colors focus:outline-none cursor-pointer"
        ...
        {isProfileOpen && (
          <>
            ...
            <div className="absolute right-0 mt-2 w-48 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 shadow-2xl py-1 z-40 animate-in fade-in slide-in-from-top-2 duration-150">
              <Link
                href="/settings"
                className="flex items-center gap-2 px-4 py-2 text-sm text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-black/5 dark:bg-white/5 hover:text-zinc-900 dark:hover:text-white transition-colors"
                onClick={() => setIsProfileOpen(false)}
              >
