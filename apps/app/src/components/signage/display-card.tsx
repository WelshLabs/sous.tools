    ...
    <div className="p-4 rounded-xl bg-[oklch(0.16_0.02_180)] border border-[oklch(0.26_0.03_180)] flex flex-col justify-between gap-3">
      <div className="flex justify-between items-start">
        <div>
          ...
          {display.portLabel ? (
            <span className="text-[10px] text-slate-500 font-mono">HDMI output: {display.portLabel}</span>
          ) : (
            <span className="text-[10px] text-primary font-mono font-medium">Standalone Web View</span>
          )}
