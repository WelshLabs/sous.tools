    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 h-[400px]">
      <div className="lg:col-span-2 flex flex-col h-full bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
        ...
        <textarea
          ...
          className="flex-1 p-3 bg-slate-950 text-zinc-900 dark:text-slate-100 font-mono text-xs resize-none focus:outline-none"
        />
      </div>
                    ...
                    <div key={d.className} className="flex flex-col gap-0.5 p-1.5 rounded hover:bg-zinc-800 text-[11px]">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-1 shrink-0">
                          ...
                          <button onClick={() => copyToClipboard(d.className)} className="text-zinc-400 dark:text-zinc-500 hover:text-zinc-700 dark:text-zinc-300 cursor-pointer p-0.5"><Copy className="w-3 h-3" /></button>
                        </div>
                      </div>
                      <span className="text-zinc-400 dark:text-zinc-500 text-[10px] leading-tight">{d.desc}</span>
                    </div>
                  ))}
                </div>
              </details>
