...
export function ModalShell({
  ...
  return (
    ...
    >
      <div
        className={`relative bg-zinc-950 border border-white/10 rounded-2xl shadow-2xl w-full ${maxWidth} max-h-[90vh] flex flex-col overflow-hidden`}
      ...
      >
        ...
        {/* Footer */}
        {footer && (
          <div className="px-5 py-3 border-t border-white/5 shrink-0 flex items-center justify-end gap-2">
            {footer}
          </div>
        )}
      </div>
