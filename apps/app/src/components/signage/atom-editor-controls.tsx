    ...
    <div className="relative">
      <div className="flex items-center justify-between gap-2">
        ...
        <button onClick={() => setOpen(!open)}
          className="px-2 py-1 bg-zinc-800 border border-white/10 rounded-lg text-xs text-zinc-200 hover:border-white/25 cursor-pointer"
...
export const BadgeControls: React.FC<{
  ...
  <div className="space-y-2.5">
    <div className="flex items-center justify-between gap-2">
      ...
      <input type="text" value={badge.text}
        ...
        className="w-32 bg-zinc-800 border border-white/10 rounded-lg px-2 py-1 text-xs text-zinc-100 focus:outline-none" />
    </div>
    ...
    <div className="flex items-center justify-between gap-2">
      ...
      <input type="text" value={badge.borderRadius ?? "4px"}
        ...
        className="w-20 bg-zinc-800 border border-white/10 rounded-lg px-2 py-1 text-xs text-zinc-100 focus:outline-none" />
    </div>
  ...
  <button onClick={() => onChange({ badge: { text: "BADGE", color: "#f55", textColor: "#fff", borderRadius: "4px" } })}
    className="w-full py-2 bg-zinc-800 border border-white/10 rounded-lg text-xs text-zinc-300 hover:border-white/25 cursor-pointer">
    + Add badge
  </button>
);
  ...
  <div className="space-y-2.5">
    <div className="flex items-center justify-between gap-2">
      ...
      <input type="text" value={style.icon ?? ""} maxLength={2}
        ...
        className="w-16 bg-zinc-800 border border-white/10 rounded-lg px-2 py-1 text-sm text-center text-zinc-100 focus:outline-none" />
    </div>
    <div className="flex items-center justify-between gap-2">
