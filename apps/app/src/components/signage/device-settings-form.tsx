  ...
  return (
    <div className="space-y-4">
      <div className="space-y-1">
        <label className="block text-xs text-slate-400">Device Name</label>
        <input
          type="text"
          required
          value={name}
      ...
      <div className="space-y-1">
        <label className="block text-xs text-slate-400">Maintenance Window</label>
        <div className="grid grid-cols-3 gap-2">
          <div>
            <label className="block text-[10px] text-slate-500 mb-0.5">Hour</label>
            <select
              value={hour}
          ...
          <div>
            <label className="block text-[10px] text-slate-500 mb-0.5">Minute</label>
            <select
              value={minute}
          ...
          <div>
            <label className="block text-[10px] text-slate-500 mb-0.5">Day of Week</label>
            <select
              value={dayOfWeek}
