...
export const MenuItemStyleModal: React.FC<MenuItemStyleModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-zinc-950 border border-white/10 rounded-3xl shadow-2xl w-full max-w-4xl flex flex-col"
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-white/5 shrink-0">
          <div>
            <h2 className="text-sm font-bold text-zinc-100">Menu Item Styles</h2>
            <p className="text-[10px] text-zinc-500 mt-0.5">Click any part of the preview to edit that element</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div className="w-72 shrink-0 border-l border-white/5 overflow-y-auto overflow-x-hidden flex flex-col">
            {selectedAtom ? (
              <div className="p-4">
                <AtomEditorPopover
                  atom={selectedAtom}
              ...
              <div className="flex flex-col items-center justify-center flex-1 gap-3 text-center px-6 py-8">
                <div className="w-12 h-12 rounded-2xl bg-zinc-800/60 border border-white/5 flex items-center justify-center">
        ...
        <div className="flex items-center justify-between px-5 py-3 border-t border-white/5 shrink-0">
          ...
          <button
            onClick={onClose}
            className="px-4 py-1.5 bg-zinc-800 border border-white/10 rounded-xl text-xs text-zinc-300 hover:border-white/20 transition-all cursor-pointer"
          >
            Done
          </button>
        </div>
