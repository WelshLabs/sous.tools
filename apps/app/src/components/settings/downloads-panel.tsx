    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="space-y-2">
        ...
        <p className="text-sm text-slate-400">
          Download the latest Signage OS images for your hardware and view instructions for flashing them to an SD card.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-slate-200 text-lg">Raspberry Pi 4 / 5 (ARM64)</h3>
            ...
            <p className="text-sm text-slate-400 mb-6">
              This is a custom-built, lightweight OS image based on Raspberry Pi OS Lite (Bookworm). It includes all necessary dependencies, hardware acceleration, and the kiosk daemon pre-configured.
            </p>
        ...
        <div className="p-6 rounded-2xl bg-zinc-900/60 border border-zinc-800/80">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="font-semibold text-slate-200 text-lg">Flashing Instructions</h3>
              <p className="text-xs text-slate-500">How to write the OS to your SD card</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-xl mt-4">
              <p className="text-xs text-red-200 flex gap-2">
                ...
                <span>
                  <strong>Warning:</strong> Flashing the image will completely erase all data on the target SD card or USB drive. Double check that you have selected the correct drive before proceeding.
                </span>
              </p>
            </div>
          </div>
