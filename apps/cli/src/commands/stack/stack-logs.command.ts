...
@Command({
  ...
  arguments: '[service]',
  description:
    'Stream logs from Docker Compose services (e.g. api, traefik, litellm, n8n, cptr, code-server)',
})
export class StackLogsCommand extends CommandRunner {
  ...
  async run(passedParams: string[], options?: StackLogsOptions): Promise<void> {
