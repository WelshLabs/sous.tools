...
export default function AdminLayout({ children }: { children: any }) {
  const sidebarContent = (
    <div className="flex flex-col gap-2 p-4">
      <div className="text-xs font-mono text-zinc-500 uppercase px-2 mb-1">
        Administration
      </div>
      <Link
        href="/admin/devices"
        className="flex items-center gap-2 p-2 hover:bg-white/5 rounded-lg text-zinc-300 hover:text-white transition-colors text-sm font-medium"
      >
