          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              <tr className="border-b border-border/50 hover:bg-accent/20">
                ...
                <td className="py-4 px-4 text-muted-foreground">
                  <span className="px-2.5 py-1 rounded-md bg-cyan-500/10 text-cyan-400 text-xs font-semibold uppercase tracking-wider">
                    Superadmin
                  </span>
                </td>
              ...
              <tr className="border-b border-border/50 hover:bg-accent/20">
                ...
                <td className="py-4 px-4 text-muted-foreground">
                  <span className="px-2.5 py-1 rounded-md bg-accent text-muted-foreground text-xs font-semibold uppercase tracking-wider">
                    User
                  </span>
                </td>
                <td className="py-4 px-4 text-right">
