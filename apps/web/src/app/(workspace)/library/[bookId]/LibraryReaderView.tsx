 ...
 */
export function LibraryReaderView({ bookId, title, pdfUrl }: LibraryReaderViewProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <BookOpen className="w-4 h-4 shrink-0" style={{ color: "var(--color-primary)" }} />
        ...
        <div className="flex items-center gap-1 ml-auto">
          ...
          <span className="text-xs font-mono w-10 text-center" style={{ color: "var(--muted-foreground)" }}>
            {zoom}%
          </span>
          <button
            type="button"
      ...
      <main className="flex-1 overflow-auto flex items-start justify-center p-4">
        {pdfUrl ? (
          ...
          >
            ...
            >
              <BookOpen className="w-9 h-9" style={{ color: "var(--color-primary)" }} />
            </div>
            ...
            <p className="text-sm max-w-xs" style={{ color: "var(--muted-foreground)" }}>
              The scraped content for book <code className="font-mono">{bookId}</code> has not yet been processed.
            </p>
          </motion.div>
        )}
      </main>
