          ...
          <form onSubmit={handleAdd} className="glass-panel p-6 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-black/5 dark:bg-black/40 border border-black/10 dark:border-white/10 rounded-md p-2 text-white"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-white text-black py-2 rounded-md font-medium hover:bg-gray-200 transition-colors mt-4"
            >
              Save Vendor
            </button>
          </form>
