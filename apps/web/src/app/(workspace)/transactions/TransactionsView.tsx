      ...
      <Table>
        ...
        <TableBody>
          {paginated.length === 0 ? (
            ...
            paginated.map((txn) => (
              <TableRow key={txn.id}>
                <TableCell className="font-mono text-zinc-500 dark:text-muted-foreground select-all">
                  {txn.external_transaction_id}
                </TableCell>
                <TableCell className="font-bold text-zinc-200">
                  {txn.pos_items?.name || "Unnamed POS Item"}
                </TableCell>
                <TableCell className="font-semibold text-zinc-500 dark:text-muted-foreground">
                  {txn.quantity_sold}
                </TableCell>
                ...
                <TableCell className="text-zinc-500 dark:text-muted-foreground">
