...
import { ShieldCheck, CloudLightning, Download, Package, ListOrdered, ClipboardList, Tv } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-sky-500/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="p-6 flex flex-col gap-3">
            ...
            <p className="text-sm text-muted-foreground">
              Directly map POS categories, items, and discounts. Automatically trigger stock updates.
            </p>
          </Card>
          <Card className="p-6 flex flex-col gap-3">
            ...
            <p className="text-sm text-muted-foreground">
              Organize tickets instantly, track preparation states, and flag rush orders in a unified display interface.
            </p>
          </Card>
          <Card className="p-6 flex flex-col gap-3">
            ...
            <p className="text-sm text-muted-foreground">
              Dynamic recipe scaling and precise baker's percentage calculations for consistent kitchen output.
            </p>
          </Card>
          <Card className="p-6 flex flex-col gap-3">
            ...
            <p className="text-sm text-muted-foreground">
              Cast live prep lists, daily specials, and custom menu signage boards natively to any television or monitor.
            </p>
          </Card>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Card className="p-8 flex flex-col justify-between border-border">
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-1">For single-station cafes.</p>
              <div className="text-4xl font-extrabold mt-6">$49<span className="text-base font-normal text-muted-foreground">/mo</span></div>
          ...
          <Card className="p-8 flex flex-col justify-between border-sky-500/50 relative shadow-[0_0_30px_rgba(56,189,248,0.1)]">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-1">For busy full-service restaurants.</p>
              <div className="text-4xl font-extrabold mt-6">$149<span className="text-base font-normal text-muted-foreground">/mo</span></div>
              <ul className="mt-8 space-y-4 text-sm text-muted-foreground">
          ...
          <Card className="p-8 flex flex-col justify-between border-border">
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-1">Multi-location hospitality groups.</p>
      ...
      <section className="py-16 border-t border-border bg-card/40">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
          ...
          <p className="text-muted-foreground max-w-md mx-auto font-light">Install our persistent BOH app on tablets, kiosks, and display controllers for continuous 24/7 cookline status.</p>
          <div className="flex flex-wrap justify-center gap-6">
            <a href="https://github.com/conarwelsh/signage-os/releases/latest" className="flex items-center gap-3 bg-card hover:bg-accent border border-border px-6 py-4 rounded-2xl transition-all">
              <Download className="w-5 h-5 text-sky-400" />
              <div className="text-left">
                <div className="text-xs text-muted-foreground">Download for Desktop</div>
            ...
            <a href="https://github.com/conarwelsh/signage-os/releases/latest" className="flex items-center gap-3 bg-card hover:bg-accent border border-border px-6 py-4 rounded-2xl transition-all">
              ...
              <div className="text-left">
                <div className="text-xs text-muted-foreground">Instant Progressive Web App</div>
            ...
            <a href="https://github.com/conarwelsh/signage-os/releases/latest" className="flex items-center gap-3 bg-card hover:bg-accent border border-border px-6 py-4 rounded-2xl transition-all">
              ...
              <div className="text-left">
                <div className="text-xs text-muted-foreground">Download Controller App</div>
      ...
      <footer className="border-t border-border py-8 px-6 text-center text-muted-foreground text-xs flex flex-col md:flex-row justify-between items-center max-w-6xl mx-auto gap-4">
        <div>&copy; 2026 SOUS.TOOLS. Empowering modern back-of-house operations. All rights reserved.</div>
